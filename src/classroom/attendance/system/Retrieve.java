...
import static classroom.attendance.system.Insert.TEMPLATE_PROPERTY;
...
public class Retrieve extends javax.swing.JFrame {
    ...
    public void DisplayMsg(String message) {
        StudentSignInView.dialogue_box_label.setText(message);
    }
    ...
    public void DrawFingerPrint(Image image) {
        StudentSignInView.finger_print_display_label.setIcon(new ImageIcon(
                image.getScaledInstance(StudentSignInView.finger_print_display_label.getWidth(),
                        StudentSignInView.finger_print_display_label.getHeight(), Image.SCALE_DEFAULT)));
        repaint();
    }
